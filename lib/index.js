...
module.exports = {
	getIdFromUsername: require('./user/getIdFromUsername').func,
	getUsernameFromId: require('./user/getUsernameFromId').func,
	getPlayerInfo: require('./user/getPlayerInfo').func,
}
